...
You must also add the following to the action handling the pagination with the partial to render 
as an argument. There is also an optional argument to delay rendering.
